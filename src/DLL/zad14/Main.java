...
public class Main {
    public static int function(DLL<Integer> lista){
        DLLNode<Integer> iterator = lista.getFirst();
        int counter = 0;

        while (iterator!=null){
            DLLNode<Integer> iterator2 = iterator.pred;
            int sum = 0, br = 0;
            ...
            if (br>0){
                float prosek = (float)sum /br;
                iterator2 = iterator.succ;
                sum = 0;
                br = 0;
