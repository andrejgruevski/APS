...
//Ден 6: Б ја споделува тајната со Е, а Ц ја споделува тајната со Ф. (5 лица)e
public class Main {
     public static int peopleAwareOfSecret(int n, int delay, int forget){
         ...
         for (int i = 2; i <= n; i++) {
             ...
             for (int j=0; j<currentSize; j++){
                 ...
                 if (person.getDelay() <= i){
                     queue.enqueue(new Person(i + delay, i + forget));
                     totalPeople++;
                 }
