package FinkiBook.DLL.Palindrome;
...
//Да се провери дали двоjно поврзаната листа е палиндром: односно ако jа изминете од почеток до краj
//и од краj до почеток, дали ´ке добиете ист збор.
public class Palindrome {
    public static boolean isPalindrome(DLL<Integer> list ){
